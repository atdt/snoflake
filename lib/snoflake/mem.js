...
Snoflake.mem = mem;
Snoflake.alloc = alloc;
Snoflake.assign = assign;
Snoflake.getterSetter = getterSetter;
Snoflake.getInt = getInt;
Snoflake.getReal = getReal;
Snoflake.getUint = getUint;
Snoflake.gets = gets;
Snoflake.puts = puts;
Snoflake.reset = reset;
Snoflake.resolve = resolve;
Snoflake.setInt = setInt;
Snoflake.setReal = setReal;
Snoflake.setUint = setUint;
Snoflake.stack = stack;
Snoflake.symbols = symbols;
