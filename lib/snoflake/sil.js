...
sil.GETD = function ( DESCR1, DESCR2, DESCR3 ) {
    // get descriptor
    cp( getd( DESCR2.addr + DESCR3.addr ), DESCR1 );
};
...
sil.MOVDIC = function ( DESCR1, N1, DESCR2, N2 ) {
    ...
    cp( getd( DESCR2.addr + N2 ), DESCR1.addr + N1 );
};
...
sil.PUTD = function ( DESCR1, DESCR2, DESCR3 ) {
    // put descriptor
    cp( DESCR3, getd( DESCR1.addr + DESCR2.addr ) );
};
